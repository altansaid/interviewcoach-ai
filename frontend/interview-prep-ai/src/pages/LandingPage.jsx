...
import ResetPassword from "./Auth/ResetPassword"; // ✅ yeni bileşen
...
const LandingPage = () => {
  ...
  const [resetToken, setResetToken] = useState(null); // ✅ eklendi
      ...
      <div className="w-full min-h-full bg-[#FFFCEF]">
        ...
        <div className="container mx-auto px-4 pt-6 pb-[100px] relative z-10">
          <header className="flex justify-between items-center mb-16">
            <div className="text-4xl text-transparent bg-clip-text bg-[radial-gradient(circle,_#FF9324_0%,_#FCD760_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">
              Interview Coach AI
            </div>
            {user ? (
              <ProfileInfoCard />
  ...
  className="pointer-events-none select-none
             absolute hidden -top-10 right-0 md:inline md:-top-10 md:-right-10
             w-60 md:w-72 lg:w-96 lg:-right-10"
  style={{ zIndex: 1 }}   // kartların ÜSTÜNDE görünmesi için
/> */}

            <section className="mt-5">
              <h2 className="text-2xl font-medium text-center mb-12 relative z-10">
              ...
              <div className="flex flex-col items-center gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full z-10">
                  {APP_FEATURES.slice(0, 3).map((feature) => (
                    <div
                      key={feature.id}
                      className="bg-[#FFFEF8] p-6 rounded-xl shadow-xs hover:shadow-lg shadow-amber-600 transition border border-amber-100 hover:border-amber-600"
                    >
