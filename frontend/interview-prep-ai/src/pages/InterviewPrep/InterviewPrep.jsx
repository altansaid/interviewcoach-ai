    ...
    try {
      ...
      const aiResponse = await axiosInstance.post(
        API_PATHS.AI.GENERATE_QUESTIONS,
        {
          ...
          domain: sessionData?.domain || "Software",
          jobDescription: sessionData?.description || "",
                  ...
                  {!isLoading &&
                    sessionData?.questions?.length === index + 1 && (
                      <div className="flex items-center justify-center mt-5">
                        <button
                          className="flex items-center gap-3 text-sm text-black font-medium bg-[#EDEBFA] px-5 py-2 mr-2 rounded text-nowrap cursor-pointer"
