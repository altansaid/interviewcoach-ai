...
const AIResponsePreview = ({ content }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto text-gray-700">
      <div className="text-[16px] leading-6 prose prose-slate dark:prose-invert max-w-none line">
        <ReactMarkdown
          ...
          components={{
            code({ node, className, children, ...props }) {
              ...
              return !isInline ? (
                ...
                <code
                  className="px-1 py-0.5 bg-[#282c34] text-[#d19a66] rounded text-sm"
                  {...props}
                >
                  {children}
                </code>
...
function CodeBlock({ code, language }) {
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-[#1E1E2F] border-b border-gray-700">
        <div className="flex items-center space-x-2">
          <LuCode size={16} className="text-gray-100" />
        ...
        >
          {copied ? (
            ...
            <LuCopy size={16} className="text-gray-100" />
          )}
          {copied && (
